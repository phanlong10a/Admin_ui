import { Grid, MuiThemeProvider, TextField, Button,
  InputAdornment, Input, TableHead, TableCell, TableRow, Checkbox, TablePagination, Radio, Dialog, DialogActions } from "@material-ui/core";
...
class SelectPersonPopup extends React.Component {
  constructor(props) {
    super(props);
  ...
  updatePageData = () => {
    ...
    personSearchByPage(searchObject).then(({ data }) => {
